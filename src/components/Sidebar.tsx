...
const NAV_ITEMS = [
  ...
  { label: 'Ideas Cloud', href: '/workspace/ideas-cloud', icon: IdeasIcon },
  ...
  { label: 'Published', href: '/published', icon: PublishedIcon },
];
    ...
    <aside className="fixed left-0 top-0 h-full w-60 bg-sidebar-bg text-sidebar-fg flex flex-col z-30">
      ...
      <div className="px-3 py-4 border-t border-white/10">
        <Link
          ...
          className={`flex items-center gap-2 px-3 py-2 text-xs rounded-lg transition-colors mb-1 ${
